# Operator Quickstart — Salt Extraction Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0893** (`cloud-itonami-isic-0893`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0893.git
cd cloud-itonami-isic-0893
```
...
- Blueprint governor key: `salt-extraction-governor`
- Likely source path: `saltops.governor.cljc`
